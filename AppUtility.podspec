#
#  Be sure to run `pod spec lint AppUtility.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Sunil Sharma"
  # s.authors            = { "Sunil Sharma" => "sunilsharma.ss08@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Sunil Sharma"
  ...
  s.source_files  = "AppUtility", "AppUtility/**/*.{h,m}"
  s.exclude_files = "AppUtility/Exclude"
